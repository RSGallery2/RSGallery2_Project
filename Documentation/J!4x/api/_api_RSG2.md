...
### RSG2 categories (v1/rsgallery2/categories: RSG2 table)
...
<details>
 <summary><code>GET v1/rsgallery2/categories</code> <code><b>/</b></code> <code>(gets 'categories' number and 'creationDate' from manifest data of RSG2 component)</code></summary>
...
> ```batch
> curl -s --show-error  -X GET "http://127.0.0.1/rsgallery25x_dev/api/index.php/v1/rsgallery2/categories" -H "Content-Type: application/json" -H "X-Joomla-Token:  ..."
> ```
...
> ```http
> ###
> GET http://127.0.0.1/rsgallery25x_dev/api/index.php/v1/rsgallery2/categories
> Accept: application/vnd.api+json
> Content-Type: application/json
> X-Joomla-Token:  ...
> ```
...
<details>
 <summary><code>GET v1/rsgallery2/categories/:id</code> <code><b>/</b></code> <code>(gets selected category variables kept in RSG2s own table)</code></summary>
...
> ```batch
> curl -s --show-error  -X GET "http://127.0.0.1/rsgallery25x_dev/api/index.php/v1/rsgallery2/categories/5" -H "Content-Type: application/json" -H "X-Joomla-Token:  ..."
> ```
...
> ```http
> ###
> GET http://127.0.0.1/rsgallery25x_dev/api/index.php/v1/rsgallery2/categories/5
> Accept: application/vnd.api+json
> Content-Type: application/json
> X-Joomla-Token:  ...
> ```
...
<details>
 <summary><code>POST v1/rsgallery2/categories</code> <code><b>/</b></code> <code>(creates a new category with data)</code></summary>
...
> ```shell
> curl -s --show-error  -X POST "http://127.0.0.1/rsgallery25x_dev/api/index.php/v1/rsgallery2/categories" -d "{\"parent_id\":1,\"title\":\"API Base\",\"modified_time\":\"2026-03-31 10:53:41\"}"  -H "Content-Type: application/json" -H "X-Joomla-Token:  ..."
> ```
...
> ```http
> ###
> POST http://127.0.0.1/rsgallery25x_dev/api/index.php/v1/rsgallery2/categories
> Accept: application/vnd.api+json
> Content-Type: application/json
> X-Joomla-Token: 
> 
...
<details>
 <summary><code>PATCH v1/rsgallery2/categories/:id</code> <code><b>/</b></code> <code>(writes parameters into selected category</code></summary>
...
> ```shell
> curl -s --show-error  -X PATCH "http://127.0.0.1/rsgallery25x_dev/api/index.php/v1/rsgallery2/categories/5" -d "{\"title\":\"API 06\"}"  -H "Content-Type: application/json" -H "X-Joomla-Token:  ..."
> ```
...
> ```http
> ###
> PATCH http://127.0.0.1/rsgallery25x_dev/api/index.php/v1/rsgallery2/categories/5
/> Accept: application/vnd.api+json
> Content-Type: application/json
> X-Joomla-Token: 
> 
...
<details>
 <summary><code>DELETE v1/rsgallery2/categories/:id</code> <code><b>/</b></code> <code>(deletes selected category)</code></summary>
...
> ```shell
> curl -s --show-error  -X DELETE "http://127.0.0.1/rsgallery25x_dev/api/index.php/v1/rsgallery2/categories/5" -H "Content-Type: application/json" -H "X-Joomla-Token:  ..."
> ```
...
> ```http
> ###
> DELETE http://127.0.0.1/rsgallery25x_dev/api/index.php/v1/rsgallery2/categories/5
> Accept: application/vnd.api+json
> Content-Type: application/json
> X-Joomla-Token: 
> ```
...
<details>
 <summary><code>GET v1/rsgallery2/images</code> <code><b>/</b></code> <code>(gets 'images' number and 'creationDate' from manifest data of RSG2 component)</code></summary>
