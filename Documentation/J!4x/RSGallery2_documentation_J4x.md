...
This is just a collection of all written documentation for the RSGallery2 web page. We are sorry for ugly parts of the style. It results from the limitation of writing in fast "Markdown syntax".
